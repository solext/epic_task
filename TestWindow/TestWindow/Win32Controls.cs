...
namespace System.Windows
{
    class Win32WindowEvents
    {
        ...
        public static void StartListening(uint id)
        {
            hhook = SetWinEventHook((uint)EventTypes.EVENT_OBJECT_LOCATIONCHANGE, (uint)EventTypes.EVENT_OBJECT_LOCATIONCHANGE, IntPtr.Zero,
                    procDelegate, id, 0, (uint)(WinHookParameter.OUTOFCONTEXT | WinHookParameter.SKIPOWNPROCESS));
        }
    ...
    public class Win32Window
    {
        ...
        */
                    ...
                    case WinAPI.WM.MBUTTONUP:
                        {
                            ...
                            if (LastPressedButton == MouseButtons.Left)
                            {
                                ...
                                if (rectangle.Contains(new System.Drawing.Point(arg.X, arg.Y)))
                                {
                                    Click(this, arg);
                                }
                            }
        ...
        public static Win32Window FromPoint(System.Drawing.Point pos)
        {
    ...
    public struct RECT
    {
        ...
        public RECT(Drawing.Rectangle r) : this(r.Left, r.Top, r.Right, r.Bottom) { }
